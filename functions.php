...
function add_suf_hatom_data($content) {
	...
	if (is_home() || is_singular() || is_archive() ) {
        $content .= '<div class="hatom-extra" hidden><span class="entry-title">'.$title.'</span> was last modified: <span class="updated"> '.$t.'</span> by <span class="author vcard"><span class="fn">Антон Белоусов</span></span></div>';
    }
    return $content;
}
